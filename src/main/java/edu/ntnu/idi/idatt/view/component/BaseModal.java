...
public abstract class BaseModal<T> extends VBox {
   ...
   *
   * @param target the data object the widget will display or operate on; may be {@code null} for
   *     widgets that require no input (e.g., confirmation dialogs)
   */
   ...
   *
   * <p>Has no effect if no callback has been registered.
   */
