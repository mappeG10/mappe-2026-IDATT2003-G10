 ...
 *
 * <p>Classes implementing this interface maintain a list of {@link GameObserver} instances and
 * notify them when relevant internal state changes occur, following the Observer pattern.
 */
public interface GameSubject {
   ...
   *
   * <p>If the observer is already registered, this method has no effect.
   *
