 ...
 *
 * <p>Stores the minimal set of fields needed to reconstruct a {@link
 * edu.ntnu.idi.idatt.model.transaction.Transaction} on game load: the direction, the stock, the
 * quantity, the price at which the trade was executed, and the week in which it occurred.
 *
...
public record TransactionDto(
    TransactionType type, String stockSymbol, BigDecimal quantity, BigDecimal price, int week) {}
