 ...
 *
 * <p>When the player chooses to finish the game, this controller liquidates all remaining portfolio
 * positions at current market prices, re-evaluates the player's status, and returns a {@link
 * GameSummary} containing the final financial statistics.
 */
public class SummaryController extends BaseController {
   ...
   *
   * <p>All share positions held at the time of this call are sold at the current market price. The
   * player's status is re-evaluated after all positions are closed. The returned {@link
   * GameSummary} reflects the player's final cash balance, total gain/loss, and earned status.
   *
