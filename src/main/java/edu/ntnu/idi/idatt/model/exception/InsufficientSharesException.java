 ...
 *
 * <p>This unchecked exception is raised during sale commitment when the portfolio contains
 * fewer shares of the target stock than the quantity requested for the transaction.</p>
 */
