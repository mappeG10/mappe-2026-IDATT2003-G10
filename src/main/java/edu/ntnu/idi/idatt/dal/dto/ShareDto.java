 ...
 *
 * <p>The underlying {@link edu.ntnu.idi.idatt.model.Stock} is referenced by its ticker symbol
 * rather than embedded directly, so the stock object can be resolved from the exchange during
 * deserialisation.
 *
 ...
 */
public record ShareDto(String stockSymbol, BigDecimal quantity, BigDecimal purchasePrice) {}
