 ...
 *
 * <p>Captures all mutable player state required to restore a game session, including the
 * current cash balance, the starting balance (used for gain/loss calculations), the
 * activity status, the current portfolio, and the full transaction history.</p>
 *
