 ...
 *
 * <p>Produced by {@link edu.ntnu.idi.idatt.controller.MarketController#previewBuy(String,
 * BigDecimal)} and {@link edu.ntnu.idi.idatt.controller.PortfolioController#previewSell(
 * edu.ntnu.idi.idatt.model.Share, BigDecimal)} to allow the user to review the financial details of
 * a trade before committing it.
 *
...
public record TransactionPreview(
    BigDecimal gross, BigDecimal commission, BigDecimal tax, BigDecimal total) {}
