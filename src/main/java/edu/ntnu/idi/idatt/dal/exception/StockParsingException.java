 ...
 *
 * <p>This exception is a specialisation of {@link DataAccessException} used exclusively
 * by readers that parse structured stock data (e.g., CSV files). It is raised when
 * a row contains the wrong number of columns, a blank symbol or company name, or an
...
public class StockParsingException extends DataAccessException {
   ...
   *
   * @param message a description of the malformed input, typically including the offending
   *                line content
   */
