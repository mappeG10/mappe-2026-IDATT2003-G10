 ...
 *
 * <p>This utility class centralises the instantiation logic so that callers do not need to
 * reference {@link Purchase} or {@link Sale} directly, keeping the rest of the codebase decoupled
 * from the concrete transaction sub-types.
 */
public class TransactionFactory {
   ...
   *
   * @param type the direction of the transaction ({@link TransactionType#PURCHASE} or {@link
   *     TransactionType#SALE}); must not be {@code null}
   ...
   * @throws IllegalArgumentException if {@code type} or {@code share} is {@code null}, or if {@code
   *     week} is less than 1
   */
