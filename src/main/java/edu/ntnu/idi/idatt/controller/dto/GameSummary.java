 ...
 *
 * <p>Produced by
 * {@link edu.ntnu.idi.idatt.controller.SummaryController#finishGame()} after all remaining
 * portfolio positions have been liquidated.</p>
 *
 ...
 * @param totalGainLoss       the absolute gain (positive) or loss (negative) relative to the
 *                            starting capital
 ...
 * @param activeWeeks         the number of distinct weeks in which at least one transaction
 *                            was committed
 */
