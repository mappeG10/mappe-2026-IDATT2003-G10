...
/**
 * Data transfer object carrying the configuration options chosen by the player on the start
 * screen.
 *
 * <p>Passed to {@link edu.ntnu.idi.idatt.controller.init.GameFactory#createController(GameSetup)}
 * to initialise a new game session.</p>
 *
 ...
 * @param source         the file path of the stock data source (e.g., a {@code .csv} file) used
