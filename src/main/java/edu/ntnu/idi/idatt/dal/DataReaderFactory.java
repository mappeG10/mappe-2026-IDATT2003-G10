 ...
 *
 * <p>Reader selection is determined by the file extension of the {@code source} path. Currently
 * supported formats:
 *
 * <ul>
 *   <li>{@code .csv} — stock data, read by {@link CsvStockReader}
 *   <li>{@code .millions} — saved game state, read by {@link JsonGameReader}
 * </ul>
 *
...
public class DataReaderFactory {
   ...
   * @throws IllegalArgumentException if {@code source} is {@code null} or blank, or if no suitable
   *     reader exists for the given file extension
   */
