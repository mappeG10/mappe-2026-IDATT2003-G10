 ...
 *
 * <p>Returned by
 * {@link edu.ntnu.idi.idatt.controller.MarketController#executeBuy(String, BigDecimal)} and
 * {@link edu.ntnu.idi.idatt.controller.PortfolioController#executeSell(
 * edu.ntnu.idi.idatt.model.Share, BigDecimal)} after a trade has been successfully committed.
 * Used to populate the receipt widget shown to the player.</p>
 *
...
public record TransactionReceipt(
  ...
  /**
   * Creates a {@code TransactionReceipt} by extracting all relevant fields from a committed
   * {@link Transaction}.
   *
