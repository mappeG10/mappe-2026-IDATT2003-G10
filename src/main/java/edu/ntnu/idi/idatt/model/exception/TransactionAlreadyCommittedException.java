 ...
 *
 * <p>Each {@link edu.ntnu.idi.idatt.model.transaction.Transaction} is single-use; calling {@code
 * commit} a second time on the same instance violates the transaction contract and triggers this
 * exception.
 */
