 ...
 *
 * <p>Implementations are responsible for locating, opening, and parsing a data source identified by
 * the {@code source} string (typically a file path), and returning a fully constructed domain
...
public interface DataReader<T> {
   ...
   *
   * @param source the location of the data source (e.g., an absolute or relative file path); must
   ...
   * @throws DataAccessException if the source exists but its contents cannot be parsed into the
   *     expected format
   */
